...
export interface LogOverview {
  ...
  request_series: Array<{ bucket_epoch: number; count: number; errors: number }>;
}
...
export interface SystemInfo {
  ...
  metrics_endpoint: { enabled: boolean; path: string; token_required: boolean; configured_by_file: boolean };
  runtime_metrics: {
