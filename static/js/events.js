...
const BUNDLED_THEME_PACKS = Object.freeze([
  ...
  { id: "anthropic", label: "Anthropic", swatch: ["#faf9f5", "#d97757"], css: "/theme-packs/anthropic/theme.css", description: "Warm ivory paper surfaces with slate ink, a single clay accent, and serif display type." },
  { id: "anthropic-dark", label: "Anthropic 深色", swatch: ["#141413", "#d97757"], css: "/theme-packs/anthropic-dark/theme.css", description: "Slate ground with warm ivory ink, the same single clay accent, and serif display type." },
]);
