...
const BUNDLED_THEME_PACKS = Object.freeze([
  ...
  { id: "co1dsand-light", label: "素宣", swatch: ["#ffffff", "#111111"], css: "/theme-packs/co1dsand-light/theme.css", description: "纸面留白、灰阶墨梯与半透明分隔线，改编自 antfu.me。" },
  { id: "co1dsand-dark", label: "松烟", swatch: ["#050505", "#f0f0f0"], css: "/theme-packs/co1dsand-dark/theme.css", description: "近黑纸面、灰阶墨梯与半透明分隔线，改编自 antfu.me。" },
]);
